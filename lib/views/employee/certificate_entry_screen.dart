...
class CertificateEntryScreen extends StatefulWidget {
  @override
  _CertificateEntryScreenState createState() => _CertificateEntryScreenState();
}

class _CertificateEntryScreenState extends State<CertificateEntryScreen> {
