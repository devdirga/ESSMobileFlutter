...
class RegistrationScreen extends StatefulWidget {
  ...
  RegistrationScreen(this.filterRequest);
...
class _RegistrationScreenState extends State<RegistrationScreen> {
  ...
  Future<ApiResponse<dynamic>>? _training;
  ...
  Widget build(BuildContext context) {
    _training = _trainingService.training(widget.filterRequest);
                ...
                if (_response.message != null) {
                  return AppError(
                    ...
                    onRetryPressed: () => setState(() {
                      _training =
                          _trainingService.training(widget.filterRequest);
                    }),
                  );
                }
                break;
  ...
  List<DataCell> _dataCells(TrainingModel item) {
    ...
    DateTime _registrationDeadline = DateFormat('yyyy-MM-ddTHH:mm:ss')
        .parse(item.registrationDeadline!, false)
        .toLocal();
